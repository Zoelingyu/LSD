LEiDA_run.py: This script uses the Leida package to extract k metastable states and calculates the probability of occurrence, dwell time, and state transition matrix.
